...
public interface StressTestFileService {
     ...
     * 更新性能测试用例信息
     */
    void update(StressTestFileEntity stressTestFileEntity);

    /**
     * 更新性能测试用例信息
     */
    void update(StressTestFileEntity stressTestFileEntity, StressTestReportsEntity stressTestReports);
     ...
     */
    void stopLocal(Long filedId, JmeterRunEntity jmeterRunEntity);
